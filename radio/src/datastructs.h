...
static inline void check_struct()
{
...
#elif defined(RADIO_ST16) || defined(PCBPA01) || defined(RADIO_TX15) || defined(RADIO_T15PRO) || defined(RADIO_TX16SMK3) || defined(RADIO_T22) || defined(RADIO_H750DEV)
  ...
  #endif
#elif defined(PCBST16) || defined(RADIO_T15PRO) || defined(RADIO_T22) || defined(RADIO_TX15)
