 ...
 *
 * AT32 version of the SD-card SPI protocol driver (ported from the STM32
 * targets/common/arm/stm32/sdcard_spi.h).
 */
...
typedef struct {
    ...
    uint8_t  SD_ERASE_TIMEOUT : 6;          /**< see section 4.10.2.6 in SD-Spec v5.00 */
