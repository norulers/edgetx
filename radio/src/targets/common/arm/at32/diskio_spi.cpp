...
/*-----------------------------------------------------------------------*/
/* This is the disk I/O front end that attaches the SD-card SPI driver   */
/* (sdcard_spi.cpp) to the FatFs common interface.                       */
/*-----------------------------------------------------------------------*/
...
static const at32_spi_t _sd_spi_hw = {
    .SPIx = SD_SPI,
    .SCK = SD_GPIO_PIN_SCK,
    .MISO = SD_GPIO_PIN_MISO,
    .MOSI = SD_GPIO_PIN_MOSI,
    .CS = SD_GPIO_PIN_CS,
    .GPIO_MUX = SD_GPIO_MUX,
    .DMA = SD_SPI_DMA,
    // DMA channel / DMAMUX mapping not configured yet -> polling fallback used
    .txDMA_Channel = nullptr,
    .rxDMA_Channel = nullptr,
    .txDMA_Mux = nullptr,
    .rxDMA_Mux = nullptr,
};
